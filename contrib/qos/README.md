...
This means one can have an always-on peppapowd instance running, and another local peppapowd/peppapow-qt instance which connects to this node and receives blocks from it.
