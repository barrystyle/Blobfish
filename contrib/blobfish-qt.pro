...
RESOURCES += src/qt/peppapow.qrc src/qt/peppapow_locale.qrc

TRANSLATIONS += src/qt/locale/peppapow_bg.ts \
                src/qt/locale/peppapow_de.ts \
                src/qt/locale/peppapow_en.ts \
                src/qt/locale/peppapow_es.ts \
                src/qt/locale/peppapow_fi.ts \
                src/qt/locale/peppapow_fr.ts \
                src/qt/locale/peppapow_it.ts \
                src/qt/locale/peppapow_ja.ts \
                src/qt/locale/peppapow_pl.ts \
                src/qt/locale/peppapow_pt.ts \
                src/qt/locale/peppapow_ru.ts \
                src/qt/locale/peppapow_sk.ts \
                src/qt/locale/peppapow_sv.ts \
                src/qt/locale/peppapow_vi.ts \
                src/qt/locale/peppapow_zh_CN.ts \
                src/qt/locale/peppapow_zh_TW.ts
