...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"zPEPPAPOWsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zPEPPAPOW denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zPEPPAPOW denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zPEPPAPOW denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zPEPPAPOW denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zPEPPAPOW denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zPEPPAPOW denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zPEPPAPOW denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zPEPPAPOW denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zPEPPAPOW denominations\n"
            "  }\n"
    ...
    obj.push_back(Pair("zPEPPAPOWsupply", zpivObj));
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for PEPPAPOW cold staking\n"
...
#ifdef ENABLE_WALLET
        // Case 1: PEPPAPOWX address and we have full public key:
