...
public:
    CMainParams()
    {
       ...
       // Network upgrades
        ...
        vSeeds.push_back(CDNSSeedData("168.100.10.23", "168.100.10.23"));     
        vSeeds.push_back(CDNSSeedData("72.5.42.2", "72.5.42.2"));   
        vSeeds.push_back(CDNSSeedData("149.248.78.20", "149.248.78.20"));    
