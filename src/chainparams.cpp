...
{
    const char* pszTimestamp = "omegax test";
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1713085798, 4351544, 0x1e0ffff0, 1, 250 * COIN);
       ...
       // Network upgrades
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;        consensus.vUpgrades[Consensus::UPGRADE_V5_DUMMY].nActivationHeight      = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        ...
        vSeeds.push_back(CDNSSeedData("168.100.9.128", "168.100.9.128"));     
        vSeeds.push_back(CDNSSeedData("64.7.199.224", "64.7.199.224"));   
        vSeeds.push_back(CDNSSeedData("193.149.190.61", "193.149.190.61"));    
