...
DashboardWidget::DashboardWidget(BLOBFISHXGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &BLOBFISHXGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
...
void DashboardWidget::loadWalletModel()
{
    if (walletModel && walletModel->getOptionsModel()) {
        ...
        connect(ui->pushImgEmpty, &QPushButton::clicked, window, &BLOBFISHXGUI::openFAQ);
        connect(ui->btnHowTo, &QPushButton::clicked, window, &BLOBFISHXGUI::openFAQ);
