...
#ifndef BLOBFISHX_CORE_NEW_GUI_BLOBFISHXGUI_H
...
/**
  BLOBFISHX GUI main class. This class represents the main window of the BLOBFISHX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BLOBFISHXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BLOBFISHXGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BLOBFISHXGUI();
...
#endif //BLOBFISHX_CORE_NEW_GUI_BLOBFISHXGUI_H
