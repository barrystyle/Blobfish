...
#include "qt/peppapow/settings/settingsnetworkwidget.h"
#include "qt/peppapow/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/peppapow/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BLOBFISHXGUI* _window, QWidget *parent) :
