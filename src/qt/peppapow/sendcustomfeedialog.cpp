...
SendCustomFeeDialog::SendCustomFeeDialog(PEPPAPOWXGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &PEPPAPOWXGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
