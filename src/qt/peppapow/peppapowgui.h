...
#ifndef PEPPAPOWX_CORE_NEW_GUI_PEPPAPOWXGUI_H
#define PEPPAPOWX_CORE_NEW_GUI_PEPPAPOWXGUI_H
...
/**
  PEPPAPOWX GUI main class. This class represents the main window of the PEPPAPOWX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PEPPAPOWXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PEPPAPOWXGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~PEPPAPOWXGUI();
...
#endif //PEPPAPOWX_CORE_NEW_GUI_PEPPAPOWXGUI_H
