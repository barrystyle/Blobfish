...
#ifndef PEPPAPOWX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define PEPPAPOWX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //PEPPAPOWX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
