...
SettingsExportCSV::SettingsExportCSV(PEPPAPOWXGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("PEPPAPOWX_tx_csv_export(*.csv)") : tr("PEPPAPOWX_addresses_csv_export(*.csv)"),
                                        nullptr);
