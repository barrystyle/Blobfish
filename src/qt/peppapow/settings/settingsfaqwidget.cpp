...
SettingsFaqWidget::SettingsFaqWidget(PEPPAPOWXGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendablePEPPAPOW,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendablePEPPAPOW,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendablePEPPAPOW,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendablePEPPAPOW,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendablePEPPAPOW, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendablePEPPAPOW);});
    ...
    if (parent)
        connect(parent, &PEPPAPOWXGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
