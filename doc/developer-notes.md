...
- [Development guidelines](#development-guidelines)
    - [General BLOBFISHX Core](#general-peppapow-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
BLOBFISHX Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
BLOBFISHX Core is a multi-threaded application, and deadlocks or other
...
However, in open source software such as BLOBFISHX Core, where everyone uses
...
pay attention to for reviewers of BLOBFISHX Core code.

General BLOBFISHX Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BLOBFISHX Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against BLOBFISHX Core so that they can be integrated
...
file descriptors it will cause problems with BLOBFISHX's `select()` loop, because
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:BLOBFISHX-Project/BLOBFISHX.git
