...
The script [extract-osx-sdk.sh](https://github.com/peppapow-project/peppapow/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
peppapow/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/peppapow-project/peppapow/blob/master/doc/README_osx.md) for troubleshooting tips.