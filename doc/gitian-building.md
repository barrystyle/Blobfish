...
*Setup instructions for a gitian build of PEPPAPOWX Core using a VM or physical system.*

Gitian is the deterministic build process that is used to build the PEPPAPOWX
...
to the PEPPAPOWX GitHub release page.
...
- [Building PEPPAPOWX Core](#building-peppapow-core)
