PEPPAPOWX Core version 3.0.4 is now available from:
...
PEPPAPOWX Core v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zPEPPAPOW protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
- #327 `aa1235a` [Main] Don't limit zPEPPAPOW spends from getting into the mempool (Fuzzbawls)
...
### GUI
- #309 `f560ffc` [UI] Better error message when too much inputs are used for spending zPEPPAPOW (Mrs-X)
...
- #328 `a6c18c8` [Main] PEPPAPOWX not responding on user quitting app (Aaron Langford)
