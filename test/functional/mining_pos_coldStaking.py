...
from test_framework.peppapow_node import PeppaPowTestNode
...
class PEPPAPOWX_ColdStakingTest(PeppaPowTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(PeppaPowTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 PEPPAPOW from the pot)
...
if __name__ == '__main__':
    PEPPAPOWX_ColdStakingTest().main()
